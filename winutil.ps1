...
$inputXML = (new-object Net.WebClient).DownloadString("https://raw.githubusercontent.com/truonglt0410/windowDebload/main/windowform.xaml") #uncomment for Production
